  ...
  <div id="id15" class="modal">
    ...
    <div class="container-fluid padding" style="color: white;">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <a href="preworkout.php" target="_blank"><button type="button" class="btn btn-outline-warning" style="font-family: 'Bebas Neue', cursive; font-size: 18px;">See All</button></a>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-4">
            <img src="image/wheyprotein.png" style="width: 250px;height: 200px;"><br>
            <a href="multivitamins.php" target="_blank"><button type="button" class="btn btn-outline-warning" style="font-family: 'Bebas Neue', cursive; font-size: 18px;">See All</button></a>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-4">
            <img src="image/massgrainers.png" style="width: 250px;height: 200px;"><br>
            <a href="massgainers.php" target="_blank"><button type="button" class="btn btn-outline-warning" style="font-family: 'Bebas Neue', cursive; font-size: 18px;">See All</button></a>
          </div>
        </div>
      </div>
      <div class="container-fluid padding" style="color: black;">
        ...
        <div class="col-lg-6">
            ...
            <a href="proteinshakes.php" target="_blank"><button type="button" class="btn btn-outline-warning" style="font-family: 'Bebas Neue', cursive; font-size: 18px;">See All</button></a>
          </div>
          <div class="col-lg-6">
            <img src="image/supplements.png" style="width: 250px;height: 200px;"><br>
            <a href="creatine.php" target="_blank"><button type="button" class="btn btn-outline-warning" style="font-family: 'Bebas Neue', cursive; font-size: 18px;">See All</button></a>
          </div>
        </div>
        <br>
      </div>
