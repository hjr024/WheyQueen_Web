          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="preworkout1.php" target="_blank"
                  >Pre-Workout</a
                >
                <a class="dropdown-item" href="multivitamins1.php" target="_blank"
                  >Multi-Vitamins</a
                >
                <a class="dropdown-item" href="massgainers1.php" target="_blank"
                  >Mass Gainers</a
                >
                <a
                  class="dropdown-item"
                  href="proteinshakes1.html"
                  target="_blank"
                  >Protein Shakes</a
                >
                <a class="dropdown-item" href="creatine1.php" target="_blank"
                  >Creatine</a
                >
              </div>
            </li>
      ...
      <div class="article-container">
        ...
        <article class="article-card">
          ...
          <div class="article-content">
            <a href="article_1.php" class="card-category"
        ...
        <article class="article-card">
          ...
          <div class="article-content">
            <a href="article_2.php" class="card-category"
        ...
        <article class="article-card">
          ...
          <div class="article-content">
            <a href="article_3.php" class="card-category"
        ...
        <article class="article-card">
          ...
          <div class="article-content">
            <a href="article_4.php" class="card-category"
        ...
        <div class="site-container">
          <div class="article-container">
            ...
            <article class="article-card">
              ...
              <div class="article-content">
                <a href="article_5.php" class="card-category"
